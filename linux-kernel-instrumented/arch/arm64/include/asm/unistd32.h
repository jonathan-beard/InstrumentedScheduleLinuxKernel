...
#define __NR_setmigrationlog 398
__SYSCALL(__NR_setmigrationlog, compat_sys_sched_setmigrationlog)
#define __NR_getmigrationlog 399
__SYSCALL(__NR_getmigrationlog, compat_sys_sched_getmigrationlog)
/* Instrumentation Mod */
